namespace Vivus.Client.Core.AttachedProperties
{
    ...
    /// <summary>
    /// Represents a base attached property to replace the vanilla WPF attached property.
    /// </summary>
        ...
        where Parent : new()
    {
        ...
        /// </summary>
        /// <param name="sender">The UI element tat his property is changed for.</param>
