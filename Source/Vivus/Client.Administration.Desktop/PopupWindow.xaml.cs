namespace Vivus.Client.Administration.Desktop
{
    using System;
    ...
    public partial class PopupWindow : Window, IPopup
    {
        ...
        public PopupWindow(Vivus.Core.Administration.ViewModels.WindowViewModel windowViewModel)
        {
            InitializeComponent();
        ...
        protected override void OnContentRendered(EventArgs e)
        {
            ...
            // Set the maximum width of the Frame to the maximum width of the content
            Frame.MaxWidth = (Frame.Content as Page).MaxWidth;
